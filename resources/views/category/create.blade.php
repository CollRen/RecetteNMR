                ...
                <div class="flex-auto p-6">
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" id="category_en" name="category_en" value="{{old('category_en')}}">
                        </div>
                        <div class="mb-3">
                            <label for="category_fr" class="form-label">Category in French</label>
                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" id="category_fr" name="category_fr" value="{{old('category_fr')}}">
                        </div>
