        ...
        <div class="mt-8">
            <h2 class="text-xl font-semibold">Étapes de préparation :</h2>
                <div>
                    ...
                    <div>
                    <a href="/etape/{{ $etape->id }}/edit" class="mt-4 inline-block rounded-md bg-blue-500 px-2 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Ajouter d'autres étapes</a>
