        ...
        <div class="w-3/4 mr-4">
            <div class="mt-12">
                <div class="flex justify-between">
                    <div>
                        ...
                        <div><button class="rounded-md bg-clr-pri2 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-clr-sec2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-clr-pri2">Ajotuer une nouvelle recette</button></div>
                </div>
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src="{{ Vite::asset('resources/img/plat.jpg') }}" alt="Recette 1" class="w-full h-56 object-cover object-center">
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-900">Titre de la recette 1</h3>
                        <p class="mt-1 text-sm text-gray-600">Description de la recette 1</p>
                        <a href="/recette" class="block mt-2 text-sm font-semibold text-blue-600">Voir la recette</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src="{{ Vite::asset('resources/img/plat.jpg') }}" alt="Recette 1" class="w-full h-56 object-cover object-center">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ $recipe['link'] }}" class="block mt-2 text-sm font-semibold text-blue-600">Voir la recette</a>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="mt-10">
            <div class="flex items-center justify-between">
                <img src="{{ Vite::asset('resources/img/pexels-eva-bronzini.jpeg') }}" alt="Recette 1" class="w-20 h-20 rounded-full">
                <div class="ml-4">
                    <h2 class="text-lg font-semibold text-gray-900">Titre de la recette 1</h2>
                    <p class="mt-2 text-sm text-gray-600">Description de la recette 1</p>
                </div>
        ...
        <div class="mt-10">
            <div class="flex items-center justify-between">
                <img src="{{ Vite::asset('resources/img/pexels-eva-bronzini.jpeg') }}" alt="Recette 2" class="w-20 h-20 rounded-full">
                <div class="ml-4">
                    <h2 class="text-lg font-semibold text-gray-900">Titre de la recette 2</h2>
                    <p class="mt-2 text-sm text-gray-600">Description de la recette 2</p>
                </div>
                <a href="" class="btn btn-primary">Voir la recette</a>
            </div>
        </div>
